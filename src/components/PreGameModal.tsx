...
export default function PreGameModal({ onStart }: Props) {
  const [selectedLevel, setSelectedLevel] = useState(6); // default
  ...
  return (
    ...
    >
      <div className="bg-gradient-to-br from-[#1a1c2c] to-[#12141f] rounded-2xl shadow-2xl p-8 w-[90%] max-w-md border border-[#2e3247]">
        {/* Trademark Header */}
        ...
        >
          {LEVELS.map((lvl) => (
            <option key={lvl.depth} value={lvl.depth}>
